...
var generateRandomString = function(length) {
    var text = '';
    var possible = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvqxyz0123456789';
...
app.get('/callback', function(req, res){
   ...
   // after checking state parameters
...
app.get('/refresh_token', function(req, res){
   ...
   // requesting access token from the refresh token
